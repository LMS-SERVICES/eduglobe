...
import { CONTACT, WHATSAPP, SOCIAL, SITE } from "@/lib/constants";
  ...
  return (
    <footer className="bg-primary-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 text-sm">
            <a
              ...
              className="flex items-center gap-2 hover:text-accent-gold transition"
            >
        ...
        <div className="mt-6 pt-6 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-white/80">
